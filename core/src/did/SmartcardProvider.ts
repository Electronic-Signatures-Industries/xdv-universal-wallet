 ...
 */
export class SmartcardProvider implements DIDProvider {
  ///@ts-ignore
  _handle: any

  constructor(pin: string, keyID: string) {
    //TODO: Must retrun Smartcard key fingerprint
    const did = encodeDID(pub, pem)
    //TODO: Move the complete did-jwt into universal wallet
